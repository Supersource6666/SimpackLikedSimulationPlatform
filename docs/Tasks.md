...
1. 轮轨接触分析页面 主视角下拉框后方放置“运行轨迹”和”列车编组“两个视窗显示和关闭的控制按钮；
2. “运行轨迹”和”列车编组“两个视窗右上角增加叉号允许点击擦掉视窗；
3. Top bar在”三维可视化“后放置“数据处理与结果评估”，点击后跳转”数据处理与结果评估“-“数据处理”页面；

地面颜色设置为#4c525a

轮轨接触分析场景中数据曲线窗口接入模拟数据；
轮轨接触分析界面中表征轮轨垂向力、横向力和纵向力的箭头也接入模拟数据；